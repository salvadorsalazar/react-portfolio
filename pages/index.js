...
<a href="https://movieapp-sage.vercel.app/" target="_blank">
            ...
            <div className="basis-1/3 flex-1">
              ...
              <div className="py-5"> <p className=" text-center bg-gradient-to-r from-cyan-500 text- to-teal-500 text-white px-4 py-2 border-none rounded-md">InteeliFridge<br></br><br></br><br></br>
